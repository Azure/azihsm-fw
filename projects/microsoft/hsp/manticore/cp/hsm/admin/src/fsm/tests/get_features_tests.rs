...
use crate::fsm::get_features::AdminGetFeaturesCmd;
use crate::fsm::types::*;
...
fn test_set_features_cmd_unknown_event() {
    ...
    const OP_CODE: AdminCommandOpCodes = AdminCommandOpCodes::GetFeatures;
    const NUM_RES: u32 = 1;
    ...
    // Create Get Features command FSM
    let mut fsm = AdminGetFeaturesCmd::new(ctx, PcieFunction::Pf, sqe, None);
...
#[test]
fn test_get_features_cmd_num_queues() {
    const ID: AdminFeatureId = AdminFeatureId::NumberOfQueues;
    const OP_CODE: AdminCommandOpCodes = AdminCommandOpCodes::GetFeatures;
    const NUM_RES: u32 = 1;
...
#[test]
fn test_get_features_cmd_fp_num_queues() {
...
#[test]
fn test_get_features_cmd_with_zero_res_cnt() {
    const ID: AdminFeatureId = AdminFeatureId::FpNumberOfQueues;
    const OP_CODE: AdminCommandOpCodes = AdminCommandOpCodes::GetFeatures;
    const NUM_RES: u32 = 0;
    const UNKNOWN_EVENT: bool = false;
...
#[test]
fn test_get_features_cmd_with_invalid_feature_id() {
