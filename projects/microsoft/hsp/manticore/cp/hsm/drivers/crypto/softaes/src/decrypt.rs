...
/*
 * Based on CM7_1T_AES_decrypt.S.
 *
 * Uses backward expanded round key
 *
 * Original author: Jan Oleksiewicz <jnk0le@hotmail.com>
 */
#[cfg(target_arch = "arm")]
pub fn cm7_1t_aes_decrypt(rk: *const u8, inp: *const u8, outp: *mut u8, rounds: u32) {
    use core::arch::asm;
    unsafe {
        asm! {
        "
