...
#[cfg(target_arch = "arm")]
#[no_mangle]
pub fn cm7_1t_aes_keyschedule_dec(rk: *mut u8, rounds: u32) {
    use core::arch::asm;
    unsafe {
        asm! {
            "
        ...
        2:	ldrd r1,r2, [r0, #-8]!
            ...
            eors r7, r6 // S{{e}}
            cmp r10, r0 // safe to compare here because EOR does not affect flags unless .s is specified
...
#[allow(unused)]
fn cm7_1t_aes_keyschedule_dec_note(rk: *mut u8, rounds: u8) {
    use core::arch::asm;
    unsafe {
        asm! {
            "
