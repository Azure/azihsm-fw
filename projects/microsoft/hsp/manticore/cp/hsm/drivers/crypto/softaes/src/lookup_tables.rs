...
// Rust does not have a way to let us specify the alightnment of an array, so we wrap in structs.
#[repr(C, align(256))]
pub struct Align256_8<const N: usize>([u8; N]);

#[repr(C, align(1024))]
pub struct Align1024_32<const N: usize>([u32; N]);

#[no_mangle]
#[used]
#[link_section = ".data.AES_SBOX"]
pub static AES_SBOX: Align256_8<256> = Align256_8([
...
#[no_mangle]
#[used]
#[link_section = ".data.AES_INV_SBOX"]
pub static AES_INV_SBOX: Align256_8<256> = Align256_8([
...
#[no_mangle]
#[used]
#[link_section = ".data.AES_TE2"]
pub static AES_TE2: Align1024_32<256> = Align1024_32([
...
#[no_mangle]
#[used]
#[link_section = ".data.AES_TD2"]
pub static AES_TD2: Align1024_32<256> = Align1024_32([
