...
impl TryFrom<DdiAesKeySize> for usize {
    ...
    fn try_from(key_size: DdiAesKeySize) -> Result<Self, Self::Error> {
        match key_size {
...
impl TryInto<DdiAesKeySize> for DdiKeyType {
    type Error = DdiAesKeySizeError;

    fn try_into(self) -> Result<DdiAesKeySize, Self::Error> {
        match self {
            DdiKeyType::Aes128 => Ok(DdiAesKeySize::Aes128),
            DdiKeyType::Aes192 => Ok(DdiAesKeySize::Aes192),
            DdiKeyType::Aes256 => Ok(DdiAesKeySize::Aes256),
            DdiKeyType::AesXtsBulk256 => Ok(DdiAesKeySize::AesXtsBulk256),
            DdiKeyType::AesGcmBulk256 => Ok(DdiAesKeySize::AesGcmBulk256),
            DdiKeyType::AesGcmBulk256Unapproved => Ok(DdiAesKeySize::AesGcmBulk256Unapproved),
            _ => Err(DdiAesKeySizeError::InvalidKeySize),
        }
    }
}
