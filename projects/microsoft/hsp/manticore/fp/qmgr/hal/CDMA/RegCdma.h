...
typedef union
{
    ...
    struct
    {
        ...
        uint32_t RSVD_2_7                    : 6;     ///<BIT [7:2] rsvd_2_7
        uint32_t CMPLT_Q0_ELEMENT_SZ         : 2;     ///<BIT [9:8] CMPLT_Q0_ELEMENT_SZ
        uint32_t RSVD_10_15                  : 6;     ///<BIT [15:10] rsvd_10_15
...
typedef union
{
    ...
    struct
    {
        ...
        uint32_t LIST0_INTRFC_SEL            : 8;     ///<BIT [31:24] LIST0_INTRFC_SEL
    } b;
} List0Cfg_t;
...
typedef union
{
    ...
    struct
    {
        ...
        uint32_t LIST1_INTRFC_SEL            : 8;     ///<BIT [31:24] LIST1_INTRFC_SEL
    } b;
} List1Cfg_t;
...
typedef union
{
    ...
    struct
    {
        ...
        uint32_t LIST2_INTRFC_SEL            : 8;     ///<BIT [31:24] LIST2_INTRFC_SEL
    } b;
} List2Cfg_t;
...
typedef union
{
    ...
    struct
    {
        ...
        uint32_t LIST3_INTRFC_SEL            : 8;     ///<BIT [31:24] LIST3_INTRFC_SEL
    } b;
} List3Cfg_t;
...
typedef union
{
    ...
    struct
    {
        ...
        uint32_t RSVD_4_13                   : 10;    ///<BIT [13:4] rsvd_4_13
        ...
        uint32_t DESCM_SRC_PRP_SGL_PRP_TBL_LENGTH_ERR : 1;     ///<BIT [19] DESCM_SRC_PRP_SGL_PRP_TBL_LENGTH_ERR
        uint32_t DESCM_SRC_PRP_SGL_LENGTH_ALIGNMENT_ERR : 1;     ///<BIT [20] DESCM_SRC_PRP_SGL_LENGTH_ALIGNMENT_ERR
        ...
        uint32_t DESCM_DEST_SGL_PRP_TBL_LENGTH_ERR : 1;     ///<BIT [28] DESCM_DEST_SGL_PRP_TBL_LENGTH_ERR
...
typedef union
{
    ...
    struct
    {
        ...
        uint32_t DIAGNOSTIC_CMD_SLOT_STATUS_0 : 22;    ///<BIT [31:10] DIAGNOSTIC_CMD_SLOT_STATUS_0
    } b;
...
typedef struct
{
    ...
    uint32_t dpeMiscellaneousControl0DpeMiscControl0;                       // 0x1C0 : DPE_miscellaneous_Control_0 /
    uint32_t dpeMiscellaneousControl1DpeMiscControl1;                       // 0x1C4 : DPE_miscellaneous_Control_1 /
    ...
    uint32_t errorInjectionErrInject;                                       // 0x1D0 : Error_Injection /
    ...
    uint8_t rsvd250[0x1000 - 0x250];                                        // 0x250 : rsvd_250
    uint32_t aesKeyVaultAddr;                                               // 0x1000 : Aes Key vault

    #ifdef LIONMS_A0_ONLY
    uint32_t diagnosticCommandSlotStatus1DiagnosticCmdSlotStatus1;          // 0x214 : Diagnostic_Command_Slot_Status_1 /
    uint32_t diagnosticCommandSlotStatus2DiagnosticCmdSlotStatus2;          // 0x218 : Diagnostic_Command_Slot_Status_2 /
    uint32_t diagnosticCommandSlotStatus3DiagnosticCmdSlotStatus3;          // 0x21C : Diagnostic_Command_Slot_Status_3 /
    uint32_t diagnosticCommandSlotStatus4DiagnosticCmdSlotStatus4;          // 0x220 : Diagnostic_Command_Slot_Status_4 /
    uint32_t diagnosticCommandSlotStatus5DiagnosticCmdSlotStatus5;          // 0x224 : Diagnostic_Command_Slot_Status_5 /
    uint32_t diagnosticCommandSlotStatus6DiagnosticCmdSlotStatus6;          // 0x228 : Diagnostic_Command_Slot_Status_6 /
    uint32_t diagnosticCommandSlotStatus7DiagnosticCmdSlotStatus7;          // 0x22C : Diagnostic_Command_Slot_Status_7 /
    #endif
...
COMPILE_ASSERT(offsetof(Cdma_t, dpeMiscellaneousControl0DpeMiscControl0) == 0x1C0, "check register structure offset");
COMPILE_ASSERT(offsetof(Cdma_t, dpeMiscellaneousControl1DpeMiscControl1) == 0x1C4, "check register structure offset");
...
COMPILE_ASSERT(offsetof(Cdma_t, errorInjectionErrInject) == 0x1D0, "check register structure offset");
...
COMPILE_ASSERT(offsetof(Cdma_t, aesKeyVaultAddr) == 0x1000, "check register structure offset");

#ifdef LIONMS_A0_ONLY
COMPILE_ASSERT(offsetof(Cdma_t, diagnosticCommandSlotStatus1DiagnosticCmdSlotStatus1) == 0x214, "check register structure offset");
COMPILE_ASSERT(offsetof(Cdma_t, diagnosticCommandSlotStatus2DiagnosticCmdSlotStatus2) == 0x218, "check register structure offset");
COMPILE_ASSERT(offsetof(Cdma_t, diagnosticCommandSlotStatus3DiagnosticCmdSlotStatus3) == 0x21C, "check register structure offset");
COMPILE_ASSERT(offsetof(Cdma_t, diagnosticCommandSlotStatus4DiagnosticCmdSlotStatus4) == 0x220, "check register structure offset");
COMPILE_ASSERT(offsetof(Cdma_t, diagnosticCommandSlotStatus5DiagnosticCmdSlotStatus5) == 0x224, "check register structure offset");
COMPILE_ASSERT(offsetof(Cdma_t, diagnosticCommandSlotStatus6DiagnosticCmdSlotStatus6) == 0x228, "check register structure offset");
COMPILE_ASSERT(offsetof(Cdma_t, diagnosticCommandSlotStatus7DiagnosticCmdSlotStatus7) == 0x22C, "check register structure offset");
#endif
