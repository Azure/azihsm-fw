...
typedef union
{
    ...
    struct
    {
        ...
        uint32_t RSVD_0                      : 15;    ///<BIT [31:17] rsvd_0
    } b;
...
typedef union
{
    ...
    struct
    {
        ...
        uint32_t RSVD_0                      : 5;     ///<BIT [31:27] rsvd_0
    } b;
...
typedef struct
{
    ...
    FpsSlotArrayRegRegisters_t fpsSlotArrayRegRegisters[128];               // 0x5000 : fps_slot_array_reg_registers /
} Fps_t;
