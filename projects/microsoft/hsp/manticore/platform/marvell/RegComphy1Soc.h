...
} Comphy1Socuphy14TrxAnaregBot4_t;
...
} Comphy1Socuphy14TrxAnaregBot19_t;
...
} Comphy1Socuphy14TrxAnaregBot25_t;
...
} Comphy1Socuphy14TrxAnaregTop130_t;
...
} Comphy1Socuphy14TrxAnaregTop133_t;
...
} Comphy1Socuphy14TrxAnaregTop145_t;
...
} Comphy1Socuphy14TrxAnaregTop148_t;
...
} Comphy1SocpmCtrlTxLaneReg1Lane_t;
...
} Comphy1SocpmCtrlTxLaneReg2Lane_t;
...
} Comphy1SocinputTxPinReg0Lane_t;
...
} Comphy1SocinputTxPinReg1Lane_t;
...
} Comphy1SocinputTxPinReg2Lane_t;
...
} Comphy1SocinputTxPinReg3Lane_t;
...
} Comphy1SocclkgenTxLaneReg1Lane_t;
...
} Comphy1SoctxSpeedConvertLane_t;
...
} Comphy1SocspdCtrlTxLaneReg1Lane_t;
...
} Comphy1SocpmCtrlRxLaneReg1Lane_t;
...
} Comphy1SocinputRxPinReg0Lane_t;
...
} Comphy1SocinputRxPinReg1Lane_t;
...
} Comphy1SocinputRxPinReg2Lane_t;
...
} Comphy1SocclkgenRxLaneReg1Lane_t;
...
} Comphy1SoctxTrainPattternReg0_t;
...
} Comphy1SoctrxTrainIfIntrLane_t;
...
} Comphy1SoctrxTrainIfIntrMask0Lane_t;
...
} Comphy1SoctrxTrainIfIntrClearLane_t;
...
} Comphy1SoclaneCfgStatus2Lane_t;
...
} Comphy1SoclaneCfgStatus3Lane_t;
...
} Comphy1SoclaneDpPie8Cfg0Lane_t;
...
} Comphy1SoclanePresetCfg4Lane_t;
...
} Comphy1SoclanePresetCfg16Lane_t;
...
} Comphy1SocglobBistLaneMargin_t;
...
} Comphy1SocglobL1SubstatesCfg_t;
...
} Comphy1SocinputPinDebugPipeReg8_t;
...
} Comphy1SocinputPinDebugPipeReg10_t;
...
} Comphy1SocinputPinDebugPipeReg11_t;
...
} Comphy1SocinputPinDebugPipeReg12_t;
...
} Comphy1SocphyRemoteCtrlCommandLane_t;
...
} Comphy1SoctrxTrainIfTimers1Lane_t;
...
} Comphy1SoctrxTrainIfTimers2Lane_t;
...
} Comphy1SoctrxTrainIfTimersEnableLane_t;
...
} Comphy1SocesmErrPopCntHighLane_t;
...
} Comphy1Socuphy14CmnAnaregTop129_t;
...
} Comphy1Socuphy14CmnAnaregTop138_t;
...
} Comphy1Socuphy14CmnAnaregTop210_t;
...
} Comphy1SocmemCmnEccErrAddress0_t;
...
} Comphy1SocxdataMemChecksumCmn2_t;
...
} Comphy1SoctxFfeCtrl2_t;

typedef struct
{
    uint8_t rsvd0[16];                                                      // 0x0 : rsvd_0 / rsvd_0
    Comphy1Socuphy14TrxAnaregBot4_t uphy14TrxAnaregBot4;                    // 0x10 : uphy14_trx_anareg_bot_4 / 
    uint8_t rsvd14[56];                                                     // 0x14 : rsvd_14 / rsvd_14
    Comphy1Socuphy14TrxAnaregBot19_t uphy14TrxAnaregBot19;                  // 0x4C : uphy14_trx_anareg_bot_19 / 
    uint8_t rsvd50[20];                                                     // 0x50 : rsvd_50 / rsvd_50
    Comphy1Socuphy14TrxAnaregBot25_t uphy14TrxAnaregBot25;                  // 0x64 : uphy14_trx_anareg_bot_25 / 
    uint8_t rsvd68[416];                                                    // 0x68 : rsvd_68 / rsvd_68
    Comphy1Socuphy14TrxAnaregTop130_t uphy14TrxAnaregTop130;                // 0x208 : uphy14_trx_anareg_top_130 / 
    uint8_t rsvd20c[8];                                                     // 0x20C : rsvd_20c / rsvd_20c
    Comphy1Socuphy14TrxAnaregTop133_t uphy14TrxAnaregTop133;                // 0x214 : uphy14_trx_anareg_top_133 / 
    uint8_t rsvd218[44];                                                    // 0x218 : rsvd_218 / rsvd_218
    Comphy1Socuphy14TrxAnaregTop145_t uphy14TrxAnaregTop145;                // 0x244 : uphy14_trx_anareg_top_145 / 
    uint8_t rsvd248[8];                                                     // 0x248 : rsvd_248 / rsvd_248
    Comphy1Socuphy14TrxAnaregTop148_t uphy14TrxAnaregTop148;                // 0x250 : uphy14_trx_anareg_top_148 / 
    uint8_t rsvd254[7596];                                                  // 0x254 : rsvd_254 / rsvd_254
    Comphy1SocpmCtrlTxLaneReg1Lane_t pmCtrlTxLaneReg1Lane;                  // 0x2000 : pm_ctrl_tx_lane_reg1_lane / 
    Comphy1SocpmCtrlTxLaneReg2Lane_t pmCtrlTxLaneReg2Lane;                  // 0x2004 : pm_ctrl_tx_lane_reg2_lane / 
    Comphy1SocinputTxPinReg0Lane_t inputTxPinReg0Lane;                      // 0x2008 : input_tx_pin_reg0_lane / 
    Comphy1SocinputTxPinReg1Lane_t inputTxPinReg1Lane;                      // 0x200C : input_tx_pin_reg1_lane / 
    Comphy1SocinputTxPinReg2Lane_t inputTxPinReg2Lane;                      // 0x2010 : input_tx_pin_reg2_lane / 
    Comphy1SocinputTxPinReg3Lane_t inputTxPinReg3Lane;                      // 0x2014 : input_tx_pin_reg3_lane / 
    uint8_t rsvd2018[8];                                                    // 0x2018 : rsvd_2018 / rsvd_2018
    Comphy1SocclkgenTxLaneReg1Lane_t clkgenTxLaneReg1Lane;                  // 0x2020 : clkgen_tx_lane_reg1_lane / 
    Comphy1SoctxSpeedConvertLane_t txSpeedConvertLane;                      // 0x2024 : tx_speed_convert_lane / 
    uint8_t rsvd2028[8];                                                    // 0x2028 : rsvd_2028 / rsvd_2028
    Comphy1SocspdCtrlTxLaneReg1Lane_t spdCtrlTxLaneReg1Lane;                // 0x2030 : spd_ctrl_tx_lane_reg1_lane / 
    Comphy1SoctxSystemLane_t txSystemLane;                                  // 0x2034 : tx_system_lane / 
    uint8_t rsvd2038[36];                                                   // 0x2038 : rsvd_2038 / rsvd_2038
    Comphy1SocmonTop_t monTop;                                              // 0x205C : mon_top / 
    uint8_t rsvd2060[160];                                                  // 0x2060 : rsvd_2060 / rsvd_2060
    Comphy1SocpmCtrlRxLaneReg1Lane_t pmCtrlRxLaneReg1Lane;                  // 0x2100 : pm_ctrl_rx_lane_reg1_lane / 
    Comphy1SocrxSystemLane_t rxSystemLane;                                  // 0x2104 : rx_system_lane / 
    Comphy1SocinputRxPinReg0Lane_t inputRxPinReg0Lane;                      // 0x2108 : input_rx_pin_reg0_lane / 
    Comphy1SocinputRxPinReg1Lane_t inputRxPinReg1Lane;                      // 0x210C : input_rx_pin_reg1_lane / 
    Comphy1SocinputRxPinReg2Lane_t inputRxPinReg2Lane;                      // 0x2110 : input_rx_pin_reg2_lane / 
    uint8_t rsvd2114[8];                                                    // 0x2114 : rsvd_2114 / rsvd_2114
    Comphy1SocclkgenRxLaneReg1Lane_t clkgenRxLaneReg1Lane;                  // 0x211C : clkgen_rx_lane_reg1_lane / 
    Comphy1SocframeSyncDetReg0_t frameSyncDetReg0;                          // 0x2120 : frame_sync_det_reg0 / 
    Comphy1SocframeSyncDetReg1_t frameSyncDetReg1;                          // 0x2124 : frame_sync_det_reg1 / 
    uint8_t rsvd2128[20];                                                   // 0x2128 : rsvd_2128 / rsvd_2128
    Comphy1SoccdrLock_t cdrLock;                                            // 0x213C : cdr_lock_reg / 
    uint8_t rsvd2140[8];                                                    // 0x2140 : rsvd_2140 / rsvd_2140
    Comphy1SocrxDataPath_t rxDataPath;                                      // 0x2148 : rx_data_path_reg / 
    uint8_t rsvd214c[20];                                                   // 0x214C : rsvd_214c / rsvd_214c
    Comphy1SocdtlReg0_t dtlReg0;                                            // 0x2160 : dtl_reg0 / 
    Comphy1SocdtlReg1_t dtlReg1;                                            // 0x2164 : dtl_reg1 / 
    Comphy1SocdtlReg2_t dtlReg2;                                            // 0x2168 : dtl_reg2 / 
    uint8_t rsvd216c[4];                                                    // 0x216C : rsvd_216c / rsvd_216c
    Comphy1SocsqReg0_t sqReg0;                                              // 0x2170 : sq_reg0 / 
    uint8_t rsvd2174[140];                                                  // 0x2174 : rsvd_2174 / rsvd_2174
    Comphy1SocmcuControlLane_t mcuControlLane;                              // 0x2200 : mcu_control_lane / 
    uint8_t rsvd2204[12];                                                   // 0x2204 : rsvd_2204 / rsvd_2204
    Comphy1SoclaneSystem0_t laneSystem0;                                    // 0x2210 : lane_system0 / 
    uint8_t rsvd2214[128];                                                  // 0x2214 : rsvd_2214 / rsvd_2214
    Comphy1SocmcuMemReg2Lane_t mcuMemReg2Lane;                              // 0x2294 : mcu_mem_reg2_lane / 
    uint8_t rsvd2298[76];                                                   // 0x2298 : rsvd_2298 / rsvd_2298
    Comphy1SocmcuCommand0_t mcuCommand0;                                    // 0x22E4 : mcu_command0 / 
    uint8_t rsvd22e8[12];                                                   // 0x22E8 : rsvd_22e8 / rsvd_22e8
    Comphy1SocmemEccErrAddress0_t memEccErrAddress0;                        // 0x22F4 : mem_ecc_err_address0 / 
    ...
    Comphy1SocptControl0_t ptControl0;                                      // 0x2300 : pt_control0 / 
    Comphy1SocptControl1_t ptControl1;                                      // 0x2304 : pt_control1 / 
    ...
    Comphy1SocptUserPattern2_t ptUserPattern2;                              // 0x2310 : pt_user_pattern2 / 
    uint32_t ptCounter0PtCntLane4716;                                       // 0x2314 : pt_counter0 / 
    Comphy1SocptCounter1_t ptCounter1;                                      // 0x2318 : pt_counter1 / 
    uint32_t ptCounter2PtErrCntLane310;                                     // 0x231C : pt_counter2 / 
    uint8_t rsvd2320[232];                                                  // 0x2320 : rsvd_2320 / rsvd_2320
    Comphy1SocdfeCtrlReg2_t dfeCtrlReg2;                                    // 0x2408 : dfe_ctrl_reg2 / 
    uint8_t rsvd240c[4];                                                    // 0x240C : rsvd_240c / rsvd_240c
    Comphy1SocrxEqClkCtrl_t rxEqClkCtrl;                                    // 0x2410 : rx_eq_clk_ctrl / 
    uint8_t rsvd2414[124];                                                  // 0x2414 : rsvd_2414 / rsvd_2414
    Comphy1SocdfeReadEvenSmReg4_t dfeReadEvenSmReg4;                        // 0x2490 : dfe_read_even_sm_reg4 / 
    uint8_t rsvd2494[12];                                                   // 0x2494 : rsvd_2494 / rsvd_2494
    Comphy1SocdfeReadOddSmReg0_t dfeReadOddSmReg0;                          // 0x24A0 : dfe_read_odd_sm_reg0 / 
    Comphy1SocdfeReadOddSmReg1_t dfeReadOddSmReg1;                          // 0x24A4 : dfe_read_odd_sm_reg1 / 
    Comphy1SocdfeReadOddSmReg2_t dfeReadOddSmReg2;                          // 0x24A8 : dfe_read_odd_sm_reg2 / 
    Comphy1SocdfeReadOddSmReg3_t dfeReadOddSmReg3;                          // 0x24AC : dfe_read_odd_sm_reg3 / 
    Comphy1SocdfeReadOddSmReg4_t dfeReadOddSmReg4;                          // 0x24B0 : dfe_read_odd_sm_reg4 / 
    uint8_t rsvd24b4[140];                                                  // 0x24B4 : rsvd_24b4 / rsvd_24b4
    Comphy1SocdfeStaticLaneReg0_t dfeStaticLaneReg0;                        // 0x2540 : dfe_static_lane_reg0 / 
    uint8_t rsvd2544[60];                                                   // 0x2544 : rsvd_2544 / rsvd_2544
    Comphy1SoceomReg0_t eomReg0;                                            // 0x2580 : eom_reg0 / 
    uint8_t rsvd2584[124];                                                  // 0x2584 : rsvd_2584 / rsvd_2584
    Comphy1SocdmeEncReg0_t dmeEncReg0;                                      // 0x2600 : dme_enc_reg0 / 
    Comphy1SocdmeEncReg1_t dmeEncReg1;                                      // 0x2604 : dme_enc_reg1 / 
    Comphy1SocdmeEncReg2_t dmeEncReg2;                                      // 0x2608 : dme_enc_reg2 / 
    Comphy1SocdmeDecReg0_t dmeDecReg0;                                      // 0x260C : dme_dec_reg0 / 
    Comphy1SocdmeDecReg1_t dmeDecReg1;                                      // 0x2610 : dme_dec_reg1 / 
    Comphy1SoctxTrainIfReg0_t txTrainIfReg0;                                // 0x2614 : tx_train_if_reg0 / 
    Comphy1SoctxTrainIfReg1_t txTrainIfReg1;                                // 0x2618 : tx_train_if_reg1 / 
    Comphy1SoctxTrainIfReg2_t txTrainIfReg2;                                // 0x261C : tx_train_if_reg2 / 
    Comphy1SoctxTrainIfReg3_t txTrainIfReg3;                                // 0x2620 : tx_train_if_reg3 / 
    Comphy1SoctxTrainPattternReg0_t txTrainPattternReg0;                    // 0x2624 : tx_train_patttern_reg0 / 
    Comphy1SoctxTrainDriverReg0_t txTrainDriverReg0;                        // 0x2628 : tx_train_driver_reg0 / 
    Comphy1SoctxTrainDriverReg1_t txTrainDriverReg1;                        // 0x262C : tx_train_driver_reg1 / 
    Comphy1SoctxTrainDriverReg2_t txTrainDriverReg2;                        // 0x2630 : tx_train_driver_reg2 / 
    uint8_t rsvd2634[24];                                                   // 0x2634 : rsvd_2634 / rsvd_2634
    Comphy1SoctxEmphCtrlReg0_t txEmphCtrlReg0;                              // 0x264C : tx_emph_ctrl_reg0 / 
    Comphy1SoclinkTrainMode0_t linkTrainMode0;                              // 0x2650 : link_train_mode0 / 
    uint8_t rsvd2654[8];                                                    // 0x2654 : rsvd_2654 / rsvd_2654
    Comphy1SoctrxTrainIfIntrLane_t trxTrainIfIntrLane;                      // 0x265C : trx_train_if_interrupt_lane / 
    Comphy1SoctrxTrainIfIntrMask0Lane_t trxTrainIfIntrMask0Lane;            // 0x2660 : trx_train_if_interrupt_mask0_lane / 
    Comphy1SoctrxTrainIfIntrClearLane_t trxTrainIfIntrClearLane;            // 0x2664 : trx_train_if_interrupt_clear_lane / 
    uint8_t rsvd2668[16];                                                   // 0x2668 : rsvd_2668 / rsvd_2668
    Comphy1SoctxTrainCtrlLane_t txTrainCtrlLane;                            // 0x2678 : tx_train_ctrl_lane / 
    Comphy1SoctxTrainIfReg8_t txTrainIfReg8;                                // 0x267C : tx_train_if_reg8 / 
    uint8_t rsvd2680[6528];                                                 // 0x2680 : rsvd_2680 / rsvd_2680
    Comphy1SoclaneCfg0_t laneCfg0;                                          // 0x4000 : lane_cfg0 / 
    Comphy1SoclaneStatus0_t laneStatus0;                                    // 0x4004 : lane_status0 / 
    Comphy1SoclaneCfgStatus2Lane_t laneCfgStatus2Lane;                      // 0x4008 : lane_cfg_status2_lane / 
    Comphy1SoclaneCfg2Lane_t laneCfg2Lane;                                  // 0x400C : lane_cfg2_lane / 
    Comphy1SoclaneCfg4_t laneCfg4;                                          // 0x4010 : lane_cfg4 / 
    Comphy1SoclaneCfgStatus3Lane_t laneCfgStatus3Lane;                      // 0x4014 : lane_cfg_status3_lane / 
    Comphy1SoclaneDpPie8Cfg0Lane_t laneDpPie8Cfg0Lane;                      // 0x4018 : lane_dp_pie8_cfg0_lane / 
    uint8_t rsvd401c[8];                                                    // 0x401C : rsvd_401c / rsvd_401c
    Comphy1SoclaneEqCfg0Lane_t laneEqCfg0Lane;                              // 0x4024 : lane_eq_cfg0_lane / 
    Comphy1SoclaneEqCfg1Lane_t laneEqCfg1Lane;                              // 0x4028 : lane_eq_cfg1_lane / 
    uint8_t rsvd402c[8];                                                    // 0x402C : rsvd_402c / rsvd_402c
    Comphy1SoclanePresetCfg4Lane_t lanePresetCfg4Lane;                      // 0x4034 : lane_preset_cfg4_lane / 
    uint8_t rsvd4038[20];                                                   // 0x4038 : rsvd_4038 / rsvd_4038
    Comphy1SoclanePresetCfg16Lane_t lanePresetCfg16Lane;                    // 0x404C : lane_preset_cfg16_lane / 
    Comphy1SoclaneCoeffMax0Lane_t laneCoeffMax0Lane;                        // 0x4050 : lane_coeff_max0_lane / 
    Comphy1SoclaneRemoteSetLane_t laneRemoteSetLane;                        // 0x4054 : lane_remote_set_lane / 
    Comphy1SoclaneEq16gCfg0Lane_t laneEq16gCfg0Lane;                        // 0x4058 : lane_eq_16g_cfg0_lane / 
    uint8_t rsvd405c[36];                                                   // 0x405C : rsvd_405c / rsvd_405c
    Comphy1SoclaneEq32gCfg0Lane_t laneEq32gCfg0Lane;                        // 0x4080 : lane_eq_32g_cfg0_lane / 
    uint8_t rsvd4084[380];                                                  // 0x4084 : rsvd_4084 / rsvd_4084
    Comphy1SocglobRstClkCtrl_t globRstClkCtrl;                              // 0x4200 : glob_rst_clk_ctrl / 
    Comphy1SocglobClkSrcLo_t globClkSrcLo;                                  // 0x4204 : glob_clk_src_lo / 
    Comphy1SocglobClkSrcHi_t globClkSrcHi;                                  // 0x4208 : glob_clk_src_hi / 
    Comphy1SocglobMiscCtrl_t globMiscCtrl;                                  // 0x420C : glob_misc_ctrl / 
    Comphy1SocglobDpSalCfg_t globDpSalCfg;                                  // 0x4210 : glob_dp_sal_cfg / 
    Comphy1SocglobDpSalCfg1_t globDpSalCfg1;                                // 0x4214 : glob_dp_sal_cfg1 / 
    Comphy1SocglobDpSalCfg3_t globDpSalCfg3;                                // 0x4218 : glob_dp_sal_cfg3 / 
    Comphy1SocglobProtocolCfg0_t globProtocolCfg0;                          // 0x421C : glob_protocol_cfg0 / 
    Comphy1SocglobPmCfg0_t globPmCfg0;                                      // 0x4220 : glob_pm_cfg0 / 
    Comphy1SocglobCounterCtrl_t globCounterCtrl;                            // 0x4224 : glob_counter_ctrl / 
    Comphy1SocglobCounterHi_t globCounterHi;                                // 0x4228 : glob_counter_hi / 
    Comphy1SocglobPmDpCtrl_t globPmDpCtrl;                                  // 0x422C : glob_pm_dp_ctrl / 
    Comphy1SocglobDpBalCfg0_t globDpBalCfg0;                                // 0x4230 : glob_dp_bal_cfg0 / 
    Comphy1SocglobDpBalCfg2_t globDpBalCfg2;                                // 0x4234 : glob_dp_bal_cfg2 / 
    Comphy1SocglobDpBalCfg4_t globDpBalCfg4;                                // 0x4238 : glob_dp_bal_cfg4 / 
    Comphy1SocglobBistCtrl_t globBistCtrl;                                  // 0x423C : glob_bist_ctrl / 
    Comphy1SocglobBistLaneType_t globBistLaneType;                          // 0x4240 : glob_bist_lane_type / 
    Comphy1SocglobBistStart_t globBistStart;                                // 0x4244 : glob_bist_start / 
    Comphy1SocglobBistMask_t globBistMask;                                  // 0x4248 : glob_bist_mask / 
    Comphy1SocglobBistResult_t globBistResult;                              // 0x424C : glob_bist_result / 
    Comphy1SocglobBistSeqrCfg_t globBistSeqrCfg;                            // 0x4250 : glob_bist_seqr_cfg / 
    Comphy1SocglobBistDataHi_t globBistDataHi;                              // 0x4254 : glob_bist_data_hi / 
    Comphy1SocglobBistLinkEq_t globBistLinkEq;                              // 0x4258 : glob_bist_link_eq / 
    Comphy1SocglobBistLaneMargin_t globBistLaneMargin;                      // 0x425C : glob_bist_lane_margin / 
    Comphy1SocglobPipeRevision_t globPipeRevision;                          // 0x4260 : glob_pipe_revision / 
    Comphy1SocglobL1SubstatesCfg_t globL1SubstatesCfg;                      // 0x4264 : glob_l1_substates_cfg / 
    uint8_t rsvd4268[5816];                                                 // 0x4268 : rsvd_4268 / rsvd_4268
    Comphy1SocinputPinDebugPipeReg8_t inputPinDebugPipeReg8;                // 0x5920 : input_pin_debug_pipe_reg8 / 
    uint8_t rsvd5924[4];                                                    // 0x5924 : rsvd_5924 / rsvd_5924
    Comphy1SocinputPinDebugPipeReg10_t inputPinDebugPipeReg10;              // 0x5928 : input_pin_debug_pipe_reg10 / 
    Comphy1SocinputPinDebugPipeReg11_t inputPinDebugPipeReg11;              // 0x592C : input_pin_debug_pipe_reg11 / 
    Comphy1SocinputPinDebugPipeReg12_t inputPinDebugPipeReg12;              // 0x5930 : input_pin_debug_pipe_reg12 / 
    uint8_t rsvd5934[1740];                                                 // 0x5934 : rsvd_5934 / rsvd_5934
    Comphy1SoccalCtrl1Lane_t calCtrl1Lane;                                  // 0x6000 : cal_ctrl1_lane / 
    uint8_t rsvd6004[4];                                                    // 0x6004 : rsvd_6004 / rsvd_6004
    Comphy1SoccalCtrl3Lane_t calCtrl3Lane;                                  // 0x6008 : cal_ctrl3_lane / 
    Comphy1SoccalCtrl4Lane_t calCtrl4Lane;                                  // 0x600C : cal_ctrl4_lane / 
    uint8_t rsvd6010[4];                                                    // 0x6010 : rsvd_6010 / rsvd_6010
    Comphy1SoccalSaveData2Lane_t calSaveData2Lane;                          // 0x6014 : cal_save_data2_lane / 
    uint8_t rsvd6018[4];                                                    // 0x6018 : rsvd_6018 / rsvd_6018
    Comphy1SocphyRemoteCtrlCommandLane_t phyRemoteCtrlCommandLane;          // 0x601C : phy_remote_ctrl_command_lane / 
    ...
    Comphy1SoctrxTrainIfTimers1Lane_t trxTrainIfTimers1Lane;                // 0x6028 : trx_train_if_timers1_lane / 
    Comphy1SoctrxTrainIfTimers2Lane_t trxTrainIfTimers2Lane;                // 0x602C : trx_train_if_timers2_lane / 
    Comphy1SoctrxTrainIfTimersEnableLane_t trxTrainIfTimersEnableLane;      // 0x6030 : trx_train_if_timers_enable_lane / 
    uint8_t rsvd6034[4];                                                    // 0x6034 : rsvd_6034 / rsvd_6034
    Comphy1SocdfeControl1_t dfeControl1;                                    // 0x6038 : dfe_control_1 / 
    uint8_t rsvd603c[8];                                                    // 0x603C : rsvd_603c / rsvd_603c
    Comphy1SocdfeControl3_t dfeControl3;                                    // 0x6044 : dfe_control_3 / 
    uint8_t rsvd6048[4];                                                    // 0x6048 : rsvd_6048 / rsvd_6048
    Comphy1SocdfeControl5_t dfeControl5;                                    // 0x604C : dfe_control_5 / 
    uint8_t rsvd6050[8];                                                    // 0x6050 : rsvd_6050 / rsvd_6050
    Comphy1SoctrainControl2_t trainControl2;                                // 0x6058 : train_control_2 / 
    uint8_t rsvd605c[8];                                                    // 0x605C : rsvd_605c / rsvd_605c
    Comphy1SocdllCal_t dllCal;                                              // 0x6064 : dll_cal / 
    uint8_t rsvd6068[4];                                                    // 0x6068 : rsvd_6068 / rsvd_6068
    Comphy1SoctrainPara1_t trainPara1;                                      // 0x606C : train_para_1 / 
    Comphy1SoctrainPara2_t trainPara2;                                      // 0x6070 : train_para_2 / 
    Comphy1SoctrainPara3_t trainPara3;                                      // 0x6074 : train_para_3 / 
    Comphy1SocdfeControl6_t dfeControl6;                                    // 0x6078 : dfe_control_6 / 
    uint8_t rsvd607c[4];                                                    // 0x607C : rsvd_607c / rsvd_607c
    Comphy1SocdfeTest1_t dfeTest1;                                          // 0x6080 : dfe_test_1 / 
    uint8_t rsvd6084[8];                                                    // 0x6084 : rsvd_6084 / rsvd_6084
    Comphy1SocdfeControl7_t dfeControl7;                                    // 0x608C : dfe_control_7 / 
    uint8_t rsvd6090[16];                                                   // 0x6090 : rsvd_6090 / rsvd_6090
    Comphy1SoccdsCtrlReg0_t cdsCtrlReg0;                                    // 0x60A0 : cds_ctrl_reg0 / 
    Comphy1SoccdsCtrlReg1_t cdsCtrlReg1;                                    // 0x60A4 : cds_ctrl_reg1 / 
    ...
    Comphy1SocesmErrPopCntHighLane_t esmErrPopCntHighLane;                  // 0x60B0 : esm_err_pop_cnt_high_lane / 
    ...
    Comphy1SocdfeResetOverwrite_t dfeResetOverwrite;                        // 0x6248 : dfe_reset_overwrite / 
    uint8_t rsvd624c[2680];                                                 // 0x624C : rsvd_624c / rsvd_624c
    Comphy1Socautospeed424_t autospeed424;                                  // 0x6CC4 : autospeed424 / 
    Comphy1Socautospeed425_t autospeed425;                                  // 0x6CC8 : autospeed425 / 
    uint8_t rsvd6ccc[68];                                                   // 0x6CCC : rsvd_6ccc / rsvd_6ccc
    Comphy1Socautospeed443_t autospeed443;                                  // 0x6D10 : autospeed443 / 
    Comphy1Socautospeed444_t autospeed444;                                  // 0x6D14 : autospeed444 / 
    Comphy1Socautospeed445_t autospeed445;                                  // 0x6D18 : autospeed445 / 
    uint8_t rsvd6d1c[72];                                                   // 0x6D1C : rsvd_6d1c / rsvd_6d1c
    Comphy1Socautospeed464_t autospeed464;                                  // 0x6D64 : autospeed464 / 
    Comphy1Socautospeed465_t autospeed465;                                  // 0x6D68 : autospeed465 / 
    uint8_t rsvd6d6c[5272];                                                 // 0x6D6C : rsvd_6d6c / rsvd_6d6c
    Comphy1Socuphy14CmnAnaregTop129_t uphy14CmnAnaregTop129;                // 0x8204 : uphy14_cmn_anareg_top_129 / 
    uint8_t rsvd8208[32];                                                   // 0x8208 : rsvd_8208 / rsvd_8208
    Comphy1Socuphy14CmnAnaregTop138_t uphy14CmnAnaregTop138;                // 0x8228 : uphy14_cmn_anareg_top_138 / 
    uint8_t rsvd822c[284];                                                  // 0x822C : rsvd_822c / rsvd_822c
    Comphy1Socuphy14CmnAnaregTop210_t uphy14CmnAnaregTop210;                // 0x8348 : uphy14_cmn_anareg_top_210 / 
    uint8_t rsvd834c[7356];                                                 // 0x834C : rsvd_834c / rsvd_834c
    Comphy1SocdtxReg0_t dtxReg0;                                            // 0xA008 : dtx_reg0 / 
    uint8_t rsvdA00c[4];                                                    // 0xA00C : rsvd_a00c / rsvd_a00c
    Comphy1SocdtxReg2_t dtxReg2;                                            // 0xA010 : dtx_reg2 / 
    uint8_t rsvdA014[4];                                                    // 0xA014 : rsvd_a014 / rsvd_a014
    Comphy1SocdtxReg4_t dtxReg4;                                            // 0xA018 : dtx_reg4 / 
    Comphy1SocdtxPhyAlignReg0_t dtxPhyAlignReg0;                            // 0xA01C : dtx_phy_align_reg0 / 
    uint8_t rsvdA020[4];                                                    // 0xA020 : rsvd_a020 / rsvd_a020
    Comphy1SocdtxPhyAlignReg1_t dtxPhyAlignReg1;                            // 0xA024 : dtx_phy_align_reg1 / 
    Comphy1SocdtxReg5_t dtxReg5;                                            // 0xA028 : dtx_reg5 / 
    Comphy1SocsrisReg0_t srisReg0;                                          // 0xA02C : sris_reg0 / 
    Comphy1SocsrisReg1_t srisReg1;                                          // 0xA030 : sris_reg1 / 
    uint8_t rsvdA034[460];                                                  // 0xA034 : rsvd_a034 / rsvd_a034
    Comphy1SocmcuControl0_t mcuControl0;                                    // 0xA200 : mcu_control_0 / 
    Comphy1SocmcuControl1_t mcuControl1;                                    // 0xA204 : mcu_control_1 / 
    Comphy1SocmcuControl2_t mcuControl2;                                    // 0xA208 : mcu_control_2 / 
    uint8_t rsvdA20c[16];                                                   // 0xA20C : rsvd_a20c / rsvd_a20c
    Comphy1SocmemoryControl0_t memoryControl0;                              // 0xA21C : memory_control_0 / 
    ...
    Comphy1SocmemoryControl4_t memoryControl4;                              // 0xA22C : memory_control_4 / 
    uint8_t rsvdA230[20];                                                   // 0xA230 : rsvd_a230 / rsvd_a230
    Comphy1SocmemCmnEccErrAddress0_t memCmnEccErrAddress0;                  // 0xA244 : mem_cmn_ecc_err_address0 / 
    uint8_t rsvdA248[168];                                                  // 0xA248 : rsvd_a248 / rsvd_a248
    Comphy1SocapbControl_t apbControl;                                      // 0xA2F0 : apb_control_reg / 
    uint8_t rsvdA2f4[12];                                                   // 0xA2F4 : rsvd_a2f4 / rsvd_a2f4
    Comphy1Soctest0_t test0;                                                // 0xA300 : test0 / 
    uint8_t rsvdA304[4];                                                    // 0xA304 : rsvd_a304 / rsvd_a304
    Comphy1Soctest2_t test2;                                                // 0xA308 : test2 / 
    Comphy1Soctest3_t test3;                                                // 0xA30C : test3 / 
    Comphy1Soctest4_t test4;                                                // 0xA310 : test4 / 
    Comphy1Socsystem_t system;                                              // 0xA314 : system / 
    Comphy1SocpmCmnReg1_t pmCmnReg1;                                        // 0xA318 : pm_cmn_reg1 / 
    Comphy1SocinputCmnPinReg0_t inputCmnPinReg0;                            // 0xA31C : input_cmn_pin_reg0 / 
    Comphy1SocinputCmnPinReg1_t inputCmnPinReg1;                            // 0xA320 : input_cmn_pin_reg1 / 
    Comphy1SocinputCmnPinReg2_t inputCmnPinReg2;                            // 0xA324 : input_cmn_pin_reg2 / 
    uint8_t rsvdA328[8];                                                    // 0xA328 : rsvd_a328 / rsvd_a328
    Comphy1SocpllcalReg1_t pllcalReg1;                                      // 0xA330 : pllcal_reg1 / 
    Comphy1SocclkgenCmnReg1_t clkgenCmnReg1;                                // 0xA334 : clkgen_cmn_reg1 / 
    Comphy1SocspdCmnReg1_t spdCmnReg1;                                      // 0xA338 : spd_cmn_reg1 / 
    Comphy1SocoutputCmnPinReg0_t outputCmnPinReg0;                          // 0xA33C : output_cmn_pin_reg0 / 
    ...
    Comphy1SocxdataMemChecksumCmn2_t xdataMemChecksumCmn2;                  // 0xA360 : xdata_mem_checksum_cmn_2 / 
    Comphy1SocmcuSdtCmn_t mcuSdtCmn;                                        // 0xA364 : mcu_sdt_cmn / 
    uint8_t rsvdA368[76];                                                   // 0xA368 : rsvd_a368 / rsvd_a368
    Comphy1SocsetLaneIsr_t setLaneIsr;                                      // 0xA3B4 : set_lane_isr / 
    uint8_t rsvdA3b8[60];                                                   // 0xA3B8 : rsvd_a3b8 / rsvd_a3b8
    Comphy1SoccmnMcu_t cmnMcu;                                              // 0xA3F4 : cmn_mcu_reg / 
    Comphy1SoccidReg0_t cidReg0;                                            // 0xA3F8 : cid_reg0 / 
    Comphy1SoccidReg1_t cidReg1;                                            // 0xA3FC : cid_reg1 / 
    uint8_t rsvdA400[15996];                                                // 0xA400 : rsvd_a400 / rsvd_a400
    Comphy1Socautospeed159_t autospeed159;                                  // 0xE27C : autospeed159 / 
    uint8_t rsvdE280[896];                                                  // 0xE280 : rsvd_e280 / rsvd_e280
    Comphy1SocfwRev_t fwRev;                                                // 0xE600 : fw_rev / 
    Comphy1SoccontrolConfig0_t controlConfig0;                              // 0xE604 : control_config0 / 
    uint8_t rsvdE608[24];                                                   // 0xE608 : rsvd_e608 / rsvd_e608
    Comphy1SoccontrolConfig7_t controlConfig7;                              // 0xE620 : control_config7 / 
    Comphy1SoccalData0_t calData0;                                          // 0xE624 : cal_data0 / 
    Comphy1SoctrainIfConfig_t trainIfConfig;                                // 0xE628 : train_if_config / 
    Comphy1SoccontrolConfig8_t controlConfig8;                              // 0xE62C : control_config8 / 
    Comphy1SoccontrolConfig9_t controlConfig9;                              // 0xE630 : control_config9 / 
    uint8_t rsvdE634[28];                                                   // 0xE634 : rsvd_e634 / rsvd_e634
    Comphy1SocmcuConfig_t mcuConfig;                                        // 0xE650 : mcu_config / 
    uint8_t rsvdE654[8];                                                    // 0xE654 : rsvd_e654 / rsvd_e654
    Comphy1SocmcuConfig1_t mcuConfig1;                                      // 0xE65C : mcu_config1 / 
    uint8_t rsvdE660[100];                                                  // 0xE660 : rsvd_e660 / rsvd_e660
    Comphy1SoclocalTxPresetTb5_t localTxPresetTb5;                          // 0xE6C4 : local_tx_preset_tb5 / 
    uint8_t rsvdE6c8[40];                                                   // 0xE6C8 : rsvd_e6c8 / rsvd_e6c8
    Comphy1SoctrainParameter1_t trainParameter1;                            // 0xE6F0 : train_parameter_1 / 
    Comphy1SoctrainParameter2_t trainParameter2;                            // 0xE6F4 : train_parameter_2 / 
    uint8_t rsvdE6f8[8];                                                    // 0xE6F8 : rsvd_e6f8 / rsvd_e6f8
    Comphy1SocrxCdrBw_t rxCdrBw;                                            // 0xE700 : rx_cdr_bw / 
    Comphy1SocrxCdrBw1_t rxCdrBw1;                                          // 0xE704 : rx_cdr_bw_1 / 
    Comphy1SocrxCdrBw2_t rxCdrBw2;                                          // 0xE708 : rx_cdr_bw_2 / 
    Comphy1SoctxFfeCtrl_t txFfeCtrl;                                        // 0xE70C : tx_ffe_ctrl / 
    Comphy1SoctxFfeCtrl1_t txFfeCtrl1;                                      // 0xE710 : tx_ffe_ctrl_1 / 
    Comphy1SoctxFfeCtrl2_t txFfeCtrl2;                                      // 0xE714 : tx_ffe_ctrl_2 / 
} Comphy1Soc_t;

COMPILE_ASSERT(offsetof(Comphy1Soc_t,uphy14TrxAnaregBot4)==0x10,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,uphy14TrxAnaregBot19)==0x4C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,uphy14TrxAnaregBot25)==0x64,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,uphy14TrxAnaregTop130)==0x208,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,uphy14TrxAnaregTop133)==0x214,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,uphy14TrxAnaregTop145)==0x244,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,uphy14TrxAnaregTop148)==0x250,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,pmCtrlTxLaneReg1Lane)==0x2000,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,pmCtrlTxLaneReg2Lane)==0x2004,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,inputTxPinReg0Lane)==0x2008,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,inputTxPinReg1Lane)==0x200C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,inputTxPinReg2Lane)==0x2010,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,inputTxPinReg3Lane)==0x2014,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,clkgenTxLaneReg1Lane)==0x2020,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,txSpeedConvertLane)==0x2024,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,spdCtrlTxLaneReg1Lane)==0x2030,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,txSystemLane)==0x2034,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,monTop)==0x205C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,pmCtrlRxLaneReg1Lane)==0x2100,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,rxSystemLane)==0x2104,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,inputRxPinReg0Lane)==0x2108,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,inputRxPinReg1Lane)==0x210C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,inputRxPinReg2Lane)==0x2110,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,clkgenRxLaneReg1Lane)==0x211C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,frameSyncDetReg0)==0x2120,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,frameSyncDetReg1)==0x2124,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,cdrLock)==0x213C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,rxDataPath)==0x2148,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,dtlReg0)==0x2160,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,dtlReg1)==0x2164,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,dtlReg2)==0x2168,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,sqReg0)==0x2170,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,mcuControlLane)==0x2200,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,laneSystem0)==0x2210,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,mcuMemReg2Lane)==0x2294,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,mcuCommand0)==0x22E4,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,memEccErrAddress0)==0x22F4,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,xdataMemChecksumLane0XdataMemChecksumExpLane310)==0x22F8,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,xdataMemChecksumLane1XdataMemChecksumLane310)==0x22FC,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,ptControl0)==0x2300,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,ptControl1)==0x2304,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,ptUserPattern0PtUserPatternLane7948)==0x2308,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,ptUserPattern1PtUserPatternLane4716)==0x230C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,ptUserPattern2)==0x2310,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,ptCounter0PtCntLane4716)==0x2314,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,ptCounter1)==0x2318,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,ptCounter2PtErrCntLane310)==0x231C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,dfeCtrlReg2)==0x2408,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,rxEqClkCtrl)==0x2410,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,dfeReadEvenSmReg4)==0x2490,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,dfeReadOddSmReg0)==0x24A0,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,dfeReadOddSmReg1)==0x24A4,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,dfeReadOddSmReg2)==0x24A8,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,dfeReadOddSmReg3)==0x24AC,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,dfeReadOddSmReg4)==0x24B0,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,dfeStaticLaneReg0)==0x2540,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,eomReg0)==0x2580,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,dmeEncReg0)==0x2600,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,dmeEncReg1)==0x2604,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,dmeEncReg2)==0x2608,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,dmeDecReg0)==0x260C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,dmeDecReg1)==0x2610,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,txTrainIfReg0)==0x2614,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,txTrainIfReg1)==0x2618,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,txTrainIfReg2)==0x261C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,txTrainIfReg3)==0x2620,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,txTrainPattternReg0)==0x2624,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,txTrainDriverReg0)==0x2628,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,txTrainDriverReg1)==0x262C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,txTrainDriverReg2)==0x2630,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,txEmphCtrlReg0)==0x264C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,linkTrainMode0)==0x2650,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,trxTrainIfIntrLane)==0x265C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,trxTrainIfIntrMask0Lane)==0x2660,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,trxTrainIfIntrClearLane)==0x2664,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,txTrainCtrlLane)==0x2678,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,txTrainIfReg8)==0x267C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,laneCfg0)==0x4000,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,laneStatus0)==0x4004,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,laneCfgStatus2Lane)==0x4008,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,laneCfg2Lane)==0x400C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,laneCfg4)==0x4010,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,laneCfgStatus3Lane)==0x4014,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,laneDpPie8Cfg0Lane)==0x4018,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,laneEqCfg0Lane)==0x4024,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,laneEqCfg1Lane)==0x4028,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,lanePresetCfg4Lane)==0x4034,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,lanePresetCfg16Lane)==0x404C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,laneCoeffMax0Lane)==0x4050,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,laneRemoteSetLane)==0x4054,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,laneEq16gCfg0Lane)==0x4058,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,laneEq32gCfg0Lane)==0x4080,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,globRstClkCtrl)==0x4200,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,globClkSrcLo)==0x4204,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,globClkSrcHi)==0x4208,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,globMiscCtrl)==0x420C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,globDpSalCfg)==0x4210,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,globDpSalCfg1)==0x4214,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,globDpSalCfg3)==0x4218,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,globProtocolCfg0)==0x421C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,globPmCfg0)==0x4220,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,globCounterCtrl)==0x4224,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,globCounterHi)==0x4228,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,globPmDpCtrl)==0x422C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,globDpBalCfg0)==0x4230,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,globDpBalCfg2)==0x4234,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,globDpBalCfg4)==0x4238,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,globBistCtrl)==0x423C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,globBistLaneType)==0x4240,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,globBistStart)==0x4244,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,globBistMask)==0x4248,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,globBistResult)==0x424C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,globBistSeqrCfg)==0x4250,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,globBistDataHi)==0x4254,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,globBistLinkEq)==0x4258,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,globBistLaneMargin)==0x425C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,globPipeRevision)==0x4260,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,globL1SubstatesCfg)==0x4264,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,inputPinDebugPipeReg8)==0x5920,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,inputPinDebugPipeReg10)==0x5928,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,inputPinDebugPipeReg11)==0x592C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,inputPinDebugPipeReg12)==0x5930,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,calCtrl1Lane)==0x6000,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,calCtrl3Lane)==0x6008,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,calCtrl4Lane)==0x600C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,calSaveData2Lane)==0x6014,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,phyRemoteCtrlCommandLane)==0x601C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,phyRemoteCtrlValueLanePhyRemoteCtrlValueLane310)==0x6020,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,phyLocalValueLanePhyLocalValueLane310)==0x6024,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,trxTrainIfTimers1Lane)==0x6028,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,trxTrainIfTimers2Lane)==0x602C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,trxTrainIfTimersEnableLane)==0x6030,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,dfeControl1)==0x6038,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,dfeControl3)==0x6044,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,dfeControl5)==0x604C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,trainControl2)==0x6058,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,dllCal)==0x6064,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,trainPara1)==0x606C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,trainPara2)==0x6070,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,trainPara3)==0x6074,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,dfeControl6)==0x6078,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,dfeTest1)==0x6080,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,dfeControl7)==0x608C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,cdsCtrlReg0)==0x60A0,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,cdsCtrlReg1)==0x60A4,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,esmPopPCntLowLaneEomPopPCntLane310)==0x60A8,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,esmErrPCntLowLaneEomErrPCntLane310)==0x60AC,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,esmErrPopCntHighLane)==0x60B0,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,esmPopNCntLowLaneEomPopNCntLane310)==0x60DC,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,esmErrNCntLowLaneEomErrNCntLane310)==0x60E0,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,dfeResetOverwrite)==0x6248,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,autospeed424)==0x6CC4,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,autospeed425)==0x6CC8,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,autospeed443)==0x6D10,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,autospeed444)==0x6D14,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,autospeed445)==0x6D18,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,autospeed464)==0x6D64,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,autospeed465)==0x6D68,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,uphy14CmnAnaregTop129)==0x8204,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,uphy14CmnAnaregTop138)==0x8228,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,uphy14CmnAnaregTop210)==0x8348,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,dtxReg0)==0xA008,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,dtxReg2)==0xA010,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,dtxReg4)==0xA018,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,dtxPhyAlignReg0)==0xA01C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,dtxPhyAlignReg1)==0xA024,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,dtxReg5)==0xA028,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,srisReg0)==0xA02C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,srisReg1)==0xA030,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,mcuControl0)==0xA200,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,mcuControl1)==0xA204,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,mcuControl2)==0xA208,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,memoryControl0)==0xA21C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,memoryControl2PmemChecksumExp310)==0xA224,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,memoryControl3PmemChecksum310)==0xA228,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,memoryControl4)==0xA22C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,memCmnEccErrAddress0)==0xA244,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,apbControl)==0xA2F0,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,test0)==0xA300,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,test2)==0xA308,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,test3)==0xA30C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,test4)==0xA310,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,system)==0xA314,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,pmCmnReg1)==0xA318,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,inputCmnPinReg0)==0xA31C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,inputCmnPinReg1)==0xA320,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,inputCmnPinReg2)==0xA324,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,pllcalReg1)==0xA330,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,clkgenCmnReg1)==0xA334,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,spdCmnReg1)==0xA338,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,outputCmnPinReg0)==0xA33C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,xdataMemChecksumCmn0XdataMemChecksumExpCmn310)==0xA358,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,xdataMemChecksumCmn1XdataMemChecksumCmn310)==0xA35C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,xdataMemChecksumCmn2)==0xA360,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,mcuSdtCmn)==0xA364,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,setLaneIsr)==0xA3B4,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,cmnMcu)==0xA3F4,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,cidReg0)==0xA3F8,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,cidReg1)==0xA3FC,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,autospeed159)==0xE27C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,fwRev)==0xE600,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,controlConfig0)==0xE604,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,controlConfig7)==0xE620,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,calData0)==0xE624,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,trainIfConfig)==0xE628,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,controlConfig8)==0xE62C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,controlConfig9)==0xE630,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,mcuConfig)==0xE650,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,mcuConfig1)==0xE65C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,localTxPresetTb5)==0xE6C4,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,trainParameter1)==0xE6F0,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,trainParameter2)==0xE6F4,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,rxCdrBw)==0xE700,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,rxCdrBw1)==0xE704,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,rxCdrBw2)==0xE708,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,txFfeCtrl)==0xE70C,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,txFfeCtrl1)==0xE710,"check register structure offset");
COMPILE_ASSERT(offsetof(Comphy1Soc_t,txFfeCtrl2)==0xE714,"check register structure offset");

//-----------------------------------------------------------------------------
//  Exported register reference (Volatile type)
//-----------------------------------------------------------------------------
extern volatile Comphy1Soc_t rComphy1Soc; ///< 0xB0140000
