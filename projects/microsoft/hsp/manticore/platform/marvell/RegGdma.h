...
typedef union
{
    ...
    struct
    {
        ...
        uint32_t RSVD                        :27;     ///<BIT [30:4] rsvd_0
...
typedef union
{
    ...
    struct
    {
        ...
        uint32_t RSVD                        :10;     ///<BIT [27:18] rsvd_0
...
typedef union
{
    ...
    struct
    {
        ...
        uint32_t RSVD                        :6;      ///<BIT [29:24] rsvd_0
...
typedef union
{
    ...
    struct
    {
        ...
        uint32_t RSVD                        :4;      ///<BIT [21:18] rsvd_0
...
typedef union
{
    ...
    struct
    {
        uint32_t GDMA_CQ_NOT_EMPTY_IRQ_EN_0  :8;      ///<BIT [7:0] gdma_cq_not_empty_irq_en_0
        uint32_t RSVD_1                      :8;      ///<BIT [15:8] rsvd_1
        uint32_t GDMA_DQ_ERR_IRQ_EN_0        :1;      ///<BIT [16] gdma_dq_err_irq_en_0
        uint32_t GDMA_CQ_ERR_IRQ_EN_0        :1;      ///<BIT [17] gdma_cq_err_irq_en_0
        uint32_t RSVD                        :4;      ///<BIT [21:18] rsvd_0
        uint32_t DATA_ACCESS_ERR_IRQ_EN_0    :1;      ///<BIT [22] data_access_err_irq_en_0
        uint32_t DATA_STRCTR_ERR_IRQ_EN_0    :1;      ///<BIT [23] data_strctr_err_irq_en_0
        uint32_t COAL_INT_GENERATED_IRQ_EN_0 :8;      ///<BIT [31:24] coal_int_generated_irq_en_0
    } b;
} GdmaGdmaIntrEnable0_t;
...
typedef union
{
    ...
    struct
    {
        uint32_t GDMA_CQ_NOT_EMPTY_IRQ_EN_1  :8;      ///<BIT [7:0] gdma_cq_not_empty_irq_en_1
        uint32_t RSVD_1                      :8;      ///<BIT [15:8] rsvd_1
        uint32_t GDMA_DQ_ERR_IRQ_EN_1        :1;      ///<BIT [16] gdma_dq_err_irq_en_1
        uint32_t GDMA_CQ_ERR_IRQ_EN_1        :1;      ///<BIT [17] gdma_cq_err_irq_en_1
        uint32_t RSVD                        :4;      ///<BIT [21:18] rsvd_0
        uint32_t DATA_ACCESS_ERR_IRQ_EN_1    :1;      ///<BIT [22] data_access_err_irq_en_1
        uint32_t DATA_STRCTR_ERR_IRQ_EN_1    :1;      ///<BIT [23] data_strctr_err_irq_en_1
        uint32_t COAL_INT_GENERATED_IRQ_EN_1 :8;      ///<BIT [31:24] coal_int_generated_irq_en_1
    } b;
} GdmaGdmaIntrEnable1_t;
...
typedef union
{
    ...
    struct
    {
        ...
        uint32_t RSVD                        :5;      ///<BIT [23:19] rsvd_0
...
typedef union
{
    ...
    struct
    {
        ...
        uint32_t RSVD                        :26;     ///<BIT [31:6] rsvd_0
    } b;
...
typedef struct
{
    ...
    GdmaGdmaIntrEnable0_t gdmaGdmaIntrEnable0;                              // 0x484 : gdma_reg_gdma_interrupt_enable_0 / 
    GdmaGdmaIntrEnable1_t gdmaGdmaIntrEnable1;                              // 0x488 : gdma_reg_gdma_interrupt_enable_1 / 
...
COMPILE_ASSERT(offsetof(Gdma_t,gdmaGdmaIntrEnable0)==0x484,"check register structure offset");
COMPILE_ASSERT(offsetof(Gdma_t,gdmaGdmaIntrEnable1)==0x488,"check register structure offset");
