...
} Spis1SpiTpmXferCtrl_t;

typedef struct
{
    Spis1SpiTpmInt_t spiTpmInt;                                             // 0x0 : SPI_TPM_INT / 
    uint32_t spiTpmTimeout;                                                 // 0x4 : SPI_TPM_TIMEOUT / 
    Spis1SpiTpmErrState_t spiTpmErrState;                                   // 0x8 : SPI_TPM_ERR_STATE / 
    uint8_t rsvdC[4];                                                       // 0xC : rsvd_c / rsvd_c
    Spis1SpiTpmXferCtrl_t spiTpmXferCtrl;                                   // 0x10 : SPI_TPM_XFER_CTRL / 
...
COMPILE_ASSERT(offsetof(Spis1_t,spiTpmInt)==0x0,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,spiTpmTimeout)==0x4,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,spiTpmErrState)==0x8,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,spiTpmXferCtrl)==0x10,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmRxData0)==0x14,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmRxData1)==0x18,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmTxData)==0x20,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmRxBufAddr)==0x30,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmTxBufAddr)==0x34,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmAccess0)==0x100,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmSts0)==0x104,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmIntfCapability0)==0x108,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmIntEnable0)==0x10C,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmIntStatus0)==0x110,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmIntVector0)==0x114,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmDidVid0)==0x118,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmRid0)==0x11C,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmAccess1)==0x140,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmSts1)==0x144,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmIntfCapability1)==0x148,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmIntEnable1)==0x14C,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmIntStatus1)==0x150,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmIntVector1)==0x154,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmDidVid1)==0x158,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmRid1)==0x15C,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmAccess2)==0x180,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmSts2)==0x184,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmIntfCapability2)==0x188,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmIntEnable2)==0x18C,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmIntStatus2)==0x190,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmIntVector2)==0x194,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmDidVid2)==0x198,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmRid2)==0x19C,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmAccess3)==0x1C0,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmSts3)==0x1C4,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmIntfCapability3)==0x1C8,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmIntEnable3)==0x1CC,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmIntStatus3)==0x1D0,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmIntVector3)==0x1D4,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmDidVid3)==0x1D8,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmRid3)==0x1DC,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmAccess4)==0x200,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmSts4)==0x204,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmIntfCapability4)==0x208,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmIntEnable4)==0x20C,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmIntStatus4)==0x210,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmIntVector4)==0x214,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmDidVid4)==0x218,"check register structure offset");
COMPILE_ASSERT(offsetof(Spis1_t,tpmRid4)==0x21C,"check register structure offset");

//-----------------------------------------------------------------------------
//  Exported register reference (Volatile type)
//-----------------------------------------------------------------------------
extern volatile Spis1_t rSpis1; ///< 0xB000B000
