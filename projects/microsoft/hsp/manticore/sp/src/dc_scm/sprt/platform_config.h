...
/* Include the definitions necessary for HSP HW. */
 ...
 */
#define MCTP_BASE_PROTOCOL_MAX_RESPONSE_TIMEOUT_MS				1000
...
/**
 *  Maximum supported size of DOE message
 */
#define DOE_MESSAGE_PLATFORM_MAX_SIZE_IN_BYTES					4096
