...
#ifndef I2C_DW_APB_SLAVE_STATIC_H_
#define I2C_DW_APB_SLAVE_STATIC_H_
...
/**
 * Initialize a static instance of an I2C DW APB slave driver.  This does not initialize the driver
 * state which must be initialized separately with i2c_dw_apb_slave_init_state.
 *
 ...
 */
#define	i2c_dw_apb_slave_static_init(state_ptr, i2c_regs, handler_ptr) { \
		.i2c_base = i2c_dw_apb_static_init (&(state_ptr)->state_base, i2c_regs, \
			I2C_DW_APB_CAPABILITIES_SLAVE_MODE, &(handler_ptr)->rx_handler.handler_base, \
			i2c_dw_apb_slave_on_shutdown, i2c_dw_apb_slave_on_start, \
			i2c_dw_apb_slave_on_rx_full, i2c_dw_apb_slave_on_rx_discard, \
			i2c_dw_apb_slave_on_read_request, i2c_dw_apb_slave_on_tx_timeout, \
			i2c_dw_apb_slave_on_tx_abort, i2c_dw_apb_slave_on_tx_depleted, \
			i2c_dw_apb_slave_on_restart, i2c_dw_apb_slave_on_stop), \
	}


#endif	/* I2C_DW_APB_SLAVE_STATIC_H_ */
