...
#ifndef I2C_DW_APB_MULTIMASTER_HANDLER_STATIC_H_
#define I2C_DW_APB_MULTIMASTER_HANDLER_STATIC_H_
 ...
 */
#define i2c_dw_apb_multimaster_handler_static_init(shutdown_func, rx_pending_func, \
...
#endif	/* I2C_DW_APB_MULTIMASTER_HANDLER_STATIC_H_ */
