...
/**
 * SPI filter opcode configuration for Micron MT25Q devices with a capacity of no more than 128Mbit.
 * These devices only support 3-byte address mode.
 */
const union spi_filter_hsp_opcode micron_opcodes_mt25q128[] = {
	{
	...
	{
		.opcode = 0x32,	// 1-1-4 Page Program
		.action = SPI_FILTER_HSP_FILTER_STATE_WRADDR_1X1X4 | SPI_FILTER_HSP_FILTER_BIT_7
	},
	{
	...
	{
		.opcode = 0x50,	// Clear Flag Status Register
	...
	{
		.opcode = 0x70,	// Read Flag Status Register
		.action = SPI_FILTER_HSP_FILTER_STATE_INACTIVE | SPI_FILTER_HSP_FILTER_BIT_7
	},
	{
	...
	{
		.opcode = 0xa2,	// 1-1-2 Page Program
		.action = SPI_FILTER_HSP_FILTER_STATE_WRADDR_1X1X2 | SPI_FILTER_HSP_FILTER_BIT_7
	},
	{
	...
	{
		.opcode = 0xd2,	// 1-2-2 Page Program
		.action = SPI_FILTER_HSP_FILTER_STATE_WRADDR_1X2X2 | SPI_FILTER_HSP_FILTER_BIT_7
	},
	{
...
/**
 * The number of filtered opcodes for Micron MT25Q devices with a capacity of no more than 128Mbit.
 */
const size_t micron_opcodes_mt25q128_count = ARRAY_SIZE (micron_opcodes_mt25q128);

/**
 * SPI filter opcode configuration for Micron MT25Q devices with a capacity of 256Mbit or 512Mbit.
 * These devices support 3 and 4-byte address mode.
 */
const union spi_filter_hsp_opcode micron_opcodes_mt25q256[] = {
	{
		.opcode = 0x02,	// 1-1-1 Page Program
		.action = SPI_FILTER_HSP_FILTER_STATE_WRADDR_1X1X1 | SPI_FILTER_HSP_FILTER_BIT_8
	},
	...
	{
		.opcode = 0x04,	// Write Disable
		.action = SPI_FILTER_HSP_FILTER_STATE_WRITE_DIS | SPI_FILTER_HSP_FILTER_BIT_8
	},
	{
		.opcode = 0x05,	// Read Status Register
		.action = SPI_FILTER_HSP_FILTER_STATE_INACTIVE | SPI_FILTER_HSP_FILTER_BIT_8
	},
	{
		.opcode = 0x06,	// Write Enable
		.action = SPI_FILTER_HSP_FILTER_STATE_WRITE_EN | SPI_FILTER_HSP_FILTER_BIT_7
...
/**
 * The number of filtered opcodes for Micron MT25Q devices with a capacity of 256Mbit or 512Mbit.
 */
const size_t micron_opcodes_mt25q256_count = ARRAY_SIZE (micron_opcodes_mt25q256);

/**
 * SPI filter opcode configuration for Micron MT25Q devices with a capacity of 256Mbit or 512Mbit.
 * These devices support 3 and 4-byte address mode.
 *
 * These devices are stacked dies and have a different die revision (B vs. A), which account for
 * slight differences in supported commands.
 */
const union spi_filter_hsp_opcode micron_opcodes_mt25q01g[] = {
	{
		.opcode = 0x02,	// 1-1-1 Page Program
		.action = SPI_FILTER_HSP_FILTER_STATE_WRADDR_1X1X1 | SPI_FILTER_HSP_FILTER_BIT_8
	},
...
/**
 * The number of filtered opcodes for Micron MT25Q devices with a capacity of at least 1Gbit.
 */
const size_t micron_opcodes_mt25q01g_count = ARRAY_SIZE (micron_opcodes_mt25q01g);
