...
#ifndef HOST_PROCESSOR_OVERLAKE_FW_H_
#define HOST_PROCESSOR_OVERLAKE_FW_H_
 ...
 */
struct host_processor_overlake_fw {
	struct host_processor base;						/**< Base host management instance. */
	struct overlake_soc_firmware *flash;			/**< The manager for the firmware image on flash. */
...
#endif	/* HOST_PROCESSOR_OVERLAKE_FW_H_ */
