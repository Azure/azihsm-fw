...
#ifndef HOST_PROCESSOR_OVERLAKE_SOC_H_
#define HOST_PROCESSOR_OVERLAKE_SOC_H_
...
/**
 * Handler for Overlake SoC events to enforce protection on all firmware images.
 */
struct host_processor_overlake_soc {
	...
	struct overlake_flash_manager *flash;	/**< The manager for SoC flash. */
	struct host_processor *boot;			/**< Protection for the boot firmware. */
	struct host_processor *nitro;			/**< Protection for the Nitro firmware. */
	enum overlake_board_type board_type;	/**< The type of Overlake board. */
	 ...
	 */
	int (*soc_boot_complete) (const struct host_processor_overlake_soc *host,
...
#endif	/* HOST_PROCESSOR_OVERLAKE_SOC_H_ */
